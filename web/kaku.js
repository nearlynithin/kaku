...
// include: /tmp/tmprstouc9_.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/kaku.data';
      var REMOTE_PACKAGE_BASE = 'kaku.data';
...
Module['FS_createPath']("/", "dataset", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_build/kaku.data');
      }
      Module['addRunDependency']('datafile_build/kaku.data');
    ...
    loadPackage({"files": [{"filename": "/dataset/t10k-images.idx3-ubyte", "start": 0, "end": 7840016}, {"filename": "/dataset/t10k-labels.idx1-ubyte", "start": 7840016, "end": 7850024}, {"filename": "/dataset/train-images.idx3-ubyte", "start": 7850024, "end": 54890040}, {"filename": "/dataset/train-labels.idx1-ubyte", "start": 54890040, "end": 54950048}], "remote_package_size": 54950048});

  })();

// end include: /tmp/tmprstouc9_.js
// include: /tmp/tmphxik05p0.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmphxik05p0.js
// include: /tmp/tmp6jfpfihi.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp6jfpfihi.js
...
var ASM_CONSTS = {
  69712: () => { if (Module.__syncing) return; Module.__syncing = true; FS.syncfs(function(err) { Module.__syncing = false; if (err) console.log(err); }); },  
 69854: () => { FS.mkdir("/save"); FS.mount(IDBFS, {}, "/save"); FS.syncfs( true, function(err) { if (err) console.log(err); Module._on_fs_ready(); }); }
};

// Imports from the Wasm binary.
var _malloc = Module['_malloc'] = makeInvalidEarlyAccess('_malloc');
var _free = Module['_free'] = makeInvalidEarlyAccess('_free');
var _on_fs_ready = Module['_on_fs_ready'] = makeInvalidEarlyAccess('_on_fs_ready');
var _predict = Module['_predict'] = makeInvalidEarlyAccess('_predict');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['on_fs_ready'] != 'undefined', 'missing Wasm export: on_fs_ready');
  assert(typeof wasmExports['predict'] != 'undefined', 'missing Wasm export: predict');
  ...
  _on_fs_ready = Module['_on_fs_ready'] = createExportWrapper('on_fs_ready', 0);
  _predict = Module['_predict'] = createExportWrapper('predict', 1);
